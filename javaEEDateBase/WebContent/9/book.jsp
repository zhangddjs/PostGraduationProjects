...
window.onload = function() {
	...
	function removeTr(trn) {
		...
		if (flag) {
			...
			window.location("../DeleteBook?id=" + trText);
		}
	}
...
<body>
	<a href="bookAddPage.jsp">添加</a>
	<table border=1 width="100%">
		<tr align="center">
			<th width="10%">id</th>
			<th width="15%">bookid</th><th width="15%">bookname</th>
			<th width="15%">price</th><th width="25%">publisherName</th>
			<th width="20%">操作</th>
		</tr>
	<%
		...
		sql = "select * from book b,publisherInfo p where b.publisher=p.id";
		try{
	...
	%>
		<tr>
			...
			<td align="center">
				<a href="bookEditPage.jsp?id=<%=rs.getString("id") %>
