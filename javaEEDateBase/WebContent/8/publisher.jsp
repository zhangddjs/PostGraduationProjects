...
window.onload = function() {
	...
	function removeTr(trn) {
		...
		if (flag) {
			...
			window.location("../DeletePub?pno=" + trText);
		}
	}
...
<body>
	...
	%>
		<tr>
			...
			<td align="center"><a href="pubEdit.jsp?id=<%=rs.getString("publisherId") %>&name=<%=rs.getString("publisherName") %>">编辑</a>&nbsp&nbsp&nbsp<a href="#">删除</a></td>
		</tr>
	<%
			}
			rs.close();
