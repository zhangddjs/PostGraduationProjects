...
<script>
	function btnDelete(id){
		if(confirm("确认删除该条记录吗?"))
			location.href="../servlet/PublisherServlet?action=delete&&id="+id;
	}
</script>
</head>
<body>
	<a href="2/publisherAdd.jsp">添加</a>&nbsp;&nbsp;
	<% 
	...
	%>
			<tr>
				...
				<td><a href="2/publisherEdit.jsp?id=<%=pub.getId() %>">编辑</a>&nbsp;<a href="#" onclick="btnDelete('<%=pub.getId() %>')">删除</a></td>
			</tr>
	<%} %>
		</table>
</body>
